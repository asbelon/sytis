...
Карта вариантов использования (КВИС) - инструмент управления требованиями к функциональной системе; управляет всей совокупностью функциональных требований (вариантов использования ПО и категориями пользователей) с учетом архитектуры ПО.

...
Оформляются артефакты данных (структура данных) для обмена между контейнерами, т.е. спецификации интерфейсов (UI и API).

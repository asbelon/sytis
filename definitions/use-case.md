...
> Контейнер определяет границы сервиса или приложения, внутри которых они испоняются (в runtime'е). Под исполнением в контексте цифровых функциональных систем в первую очередь поразумевается работа с данными. Деление на сервисы и приложения отражает подход многоуровневой архитектуры (деление на уровни абстрации) (презентационный слой)
{.is-info}

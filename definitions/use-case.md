...
> Контейнер определяет границы сервиса или приложения, внутри которых они испоняются (runtime). Под исполнением в контексте цифровых функциональных систем в первую очередь поразумевается работа с данными. Деление на сервисы и приложения может отражать подход слоистой архитектуры (деление на уровни абстрации)
{.is-info}
